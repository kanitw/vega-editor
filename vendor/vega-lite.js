...
},{"../channel":10,"../fielddef":48,"../mark":51,"../sort":54,"../spec":55,"../timeunit":57,"../type":59,"../util":60,"./facet":28,"./layer":29,"./unit":42}],13:[function(require,module,exports){
"use strict";
...
},{"../channel":10,"../config":43,"../encoding":46,"../fielddef":48,"../mark":51,"../util":60}],15:[function(require,module,exports){
"use strict";
...
(function (bar) {
    ...
    function properties(model) {
        ...
        if (stack && channel_1.X === stack.fieldChannel) {
            ...
            if (model.has(channel_1.X)) {
                if (model.scale(channel_1.X).bandSize === scale_1.BANDSIZE_FIT) {
                    p.x = {
                        scale: model.scaleName(channel_1.X),
                        field: model.field(channel_1.X),
                        offset: 0.5
        ...
        if (stack && channel_1.Y === stack.fieldChannel) {
            ...
            if (model.has(channel_1.Y)) {
                if (model.scale(channel_1.Y).bandSize === scale_1.BANDSIZE_FIT) {
                    p.y = {
                        scale: model.scaleName(channel_1.Y),
                        field: model.field(channel_1.Y),
                        offset: 0.5
...
},{"../../channel":10,"../../config":43,"../../encoding":46,"../../fielddef":48,"../../mark":51,"../../scale":52,"../../util":60,"../common":12,"./area":32,"./bar":33,"./line":34,"./point":36,"./rule":37,"./text":38,"./tick":39}],36:[function(require,module,exports){
"use strict";
var channel_1 = require('../../channel');
var fielddef_1 = require('../../fielddef');
var common_1 = require('../common');
